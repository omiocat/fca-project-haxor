[![Socket Badge](https://socket.dev/api/badge/npm/package/fca-project-haxor)](https://socket.dev/npm/package/fca-project-haxor)
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/omiocat)
...
+ Remade by Ivan Cotacte (https://www.facebook.com/abdullah.raqhaman.49) (https://github.com/omiocat)
...
```bash
npm i fca-project-haxor
```
or
```bash
npm install fca-project-haxor
```
...
```bash
npm install fca-project-haxor@latest
```
Or
```bash
npm i fca-project-haxor@latest
```
...
```javascript
const login = require("fca-project-haxor"); // get it from lib
...
```js
     var login = require('fca-project-haxor')
```
...
```js
const fs = require("fs");
const login = require("fca-project-haxor");
